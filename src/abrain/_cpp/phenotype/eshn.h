...
#if DEBUG_QUADTREE
//#define DEBUG_QUADTREE_DIVISION 1
//#define DEBUG_QUADTREE_PRUNING 1
//#define DEBUG_QUADTREE_IMAGES 1 // Not implemented (see C++ repo)
#endif
...
struct Connection_t {
  ...
  float weight{};
#if DEBUG_ES
  friend std::ostream& operator<< (std::ostream &os, const Connection_t &c) {
